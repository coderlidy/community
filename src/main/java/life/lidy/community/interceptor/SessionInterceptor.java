package life.lidy.community.interceptor;
            ...
            for(Cookie cookie:cookies){
                if(cookie.getName().equals("token")){
                    ...
                    if(users.size()!=0){
                        ...
                        request.getSession().setAttribute("unreadCount",notificationService.unreadCount(Long.valueOf(users.get(0).getAccountId())));
                    }
                    break;
                }
            }
